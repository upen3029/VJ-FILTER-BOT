...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001649672107'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1638479151').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001855189131').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1001874570525') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-4220712642') # give your force subscribe group id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001902366189')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://upen3029kumbhakar:FTWNsLHc1fl97BfU@cluster0.cakzsvx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/37f5091d521cd68e7c174.jpg')
PAYMENT_TEXT = environ.get("""𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐏𝐥𝐚𝐧𝐬 :
...
✓  Watch in 480p »to» (4K) HDR Quality.
✓  Request Any Content As You Want?
✓  No Extra fees. But Extra Features🎉
✓ All Movie's in File Format
✓ All Languages Movies Available 
✓ TV shows 
✓ No Any channel logo on Movies "All movies watermark free
✓ Index fast download link
...
After Payment Message Here With Screenshot 👇

https://t.me/anno3029

Check your plan: /myplans""" )
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'anno3029') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+f-p2Lk3a5fRiNTBl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/bongo_verse')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/bongo_verse/731')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/bongo_verse/731')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'bongo_verse') # Support Chat Link Without https:// or @
